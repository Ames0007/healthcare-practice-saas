...
/** Item 360° — Lots tab (UI-008ABCD Gate 2). */
export default function StockItemLotsRoutePage() {
  ...
  return <ItemDetailPage itemId={id} activeTab="lots" state={ready ? "loaded" : "loading"} />;
}
