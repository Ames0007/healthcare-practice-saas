...
| UI-003B | COMPLETE | (pending) | Create/edit patient prototype: primary+complementary form, responsible practitioner, duplicate detection (phone/name) with Open Existing/Create Anyway, prototype patient-number generation (mock data only, no Patient 360°, no backend integration) |
