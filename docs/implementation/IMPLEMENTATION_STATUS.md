...
| UI-004A | COMPLETE | (pending) | Patient 360° header + overview: persistent header, 6 real tab routes, Aperçu (4 summary cards + activity timeline), not-found/loading/error states (mock data only, no Dossier Santé/Treatments/Finance detail, no backend integration) |
